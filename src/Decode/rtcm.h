...
class rtcm_c : public decode_data_c {
/* Constructor */
public:
    rtcm_c();
    virtual ~rtcm_c();
...
protected:
    ...
    int obsindex(gtime_c time,int sat);
public:
...
public:
    ...
    gtime_c time_s;                     /* message start time */
    ...
    gtime_c lltime[MAXSAT][NFREQ+NEXOBS]; /* last lock time */
