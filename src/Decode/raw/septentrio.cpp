...
void sbf::adj_utcweek(gtime_c ttt,double *utc) {
    int week;
...
gtime_c sbf::adjday(gtime_c ttt,double tddd) {
    double tod_p;
    gtime_c adjd;
...
double sbf::getSigFreq(int _signType,int freqNo) {
    ...
    case 28:	return FREQ2_BDS;						/* CMPL1   */
    case 29:	return FREQ7_BDS;						/* CMPE5B  */
    case 30:	return FREQ6_BDS;						/* CMPB3   */
    }
    return FREQ1;
}
/* adjust weekly rollover of gps time ------------------------------------- */
gtime_c sbf::adjweek(gtime_c ttt,double tow) {
    double tow_p;
    int week;
    gtime_c adjw;
