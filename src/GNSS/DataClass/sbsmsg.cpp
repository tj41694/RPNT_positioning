...
int gnss_sbsmsg_c::decode_longcorr0(int p,gnss_sbssat_c *sbssat) {
...
int gnss_sbsmsg_c::decode_longcorr1(int p,gnss_sbssat_c *sbssat) {
...
int gnss_sbsmsg_c::decode_longcorrh(int p,gnss_sbssat_c *sbssat) {
...
int gnss_sbsmsg_c::decode_sbstype1(gnss_sbssat_c *sbssat) {
    int i,n,sat;
...
int gnss_sbsmsg_c::decode_sbstype2(gnss_sbssat_c *sbssat) {
...
int gnss_sbsmsg_c::decode_sbstype6(gnss_sbssat_c *sbssat) {
    int i,iodf[4],udre;
...
int gnss_sbsmsg_c::decode_sbstype7(gnss_sbssat_c *sbssat) {
    int i;
...
int gnss_sbsmsg_c::decode_sbstype9(gnss_nav_c *nav) {
    gnss_seph_c seph=gnss_seph_c();
    int i,sat,t;
...
int gnss_sbsmsg_c::decode_sbstype18(gnss_sbsion_c *sbsion) {
...
int gnss_sbsmsg_c::decode_sbstype24(gnss_sbssat_c *sbssat) {
...
int gnss_sbsmsg_c::decode_sbstype25(gnss_sbssat_c *sbssat) {
    return decode_longcorrh(14,sbssat)&&decode_longcorrh(120,sbssat);
}
/* decode type 26: ionospheric deley corrections ---------------------------- */
int gnss_sbsmsg_c::decode_sbstype26(gnss_sbsion_c *sbsion) {
...
* args   : gtime_c time     I   reception time
*          int    sat       I   satellite
*          gnss_nav_c  *nav      I   navigation data
...
*----------------------------------------------------------------------------- */
int gnss_sbsmsg_c::sbsupdatecorr(gnss_nav_c *nav) {
